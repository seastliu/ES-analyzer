...
public class PinyinTest {
	...
	public void testMultiPinyin(){
		List<String> result1 = (Pinyin.multiplePinyin(str));
		System.out.println("词语：" + str + "，拼音："+result1);
	}

	@Test
	public void testPinyin(){
		List<String> result1 = (Pinyin.pinyin(str));
    ...
    public void testInsertPinyin(){
        ...
        System.out.println("result1:"+result1);
        Pinyin.insertPinyin("三一重工", new String[]{"san1","yi1","zhong4","gong1"});

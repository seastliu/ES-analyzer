...
public class PinyinAnalysisTest {
    ...
    @Test
    public void testMultipleSimpleTokenFilter() throws IOException {
        ...
        StringReader sr = new StringReader("三一重工");
    ...
    @Test
    public void testMultipleFullTokenFilter() throws IOException {
        PinyinConfig config = new PinyinConfig();
